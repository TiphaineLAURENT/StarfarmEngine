...
namespace star
{
    ...
    enum class RIGIDBODY_FLAGS : unsigned
    {
        ISLAND = 0x0001,
        AUTO_SLEEP = 0x0004,
        BULLET = 0x0008,
    ...
    public:
        ...
        // void update_velocity(ecs::Interval deltaTime); // const Vector<2>
        // &gravity, void update_position(ecs::Interval deltaTime); void
        // update(ecs::Interval deltaTime);
