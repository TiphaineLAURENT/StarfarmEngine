...
inline auto operator "" _catch_sr(
        char const *rawChars,
        std::size_t size
...
namespace Catch
{
  ...
  namespace Generators
  {
    ...
    ) -> decltype(std::declval<decltype(generatorExpression())>().get())
    {
            ...
            auto const &generator = static_cast<IGenerator<UnderlyingType> const &>( *tracker
                    .getGenerator());
...
namespace Catch
{
  namespace Generators
  {
    ...
    {
            return GeneratorWrapper<T>(
                    pf::make_unique<TakeGenerator<T>>(
                            target,
                            std::move(
                                    generator
                            )
    ...
    {
            return GeneratorWrapper<T>(
                    pf::make_unique<RepeatGenerator<T>>(
                            repeats,
                            std::move(generator)
                    )
            );
    ...
    )
    {
            return GeneratorWrapper<std::vector<T>>(
                    pf::make_unique<ChunkGenerator<T>>(
                            size,
                            std::move(generator)
                    )
            );
...
namespace Catch
{
  ...
  private:
          ...
          void addPattern()
          {
                  ...
                  for (
                          std::size_t i = 0; i < m_escapeChars.size(); ++i
                          ) {
                                  token = token.substr(
                                          0,
                                          m_escapeChars[i] - m_start - i
...
namespace Catch
{
          ...
          : IStreamingReporter
  {
                    ...
                    stream(_config.stream())
          {
                  ...
                  if (!DerivedT::getSupportedVerbosities()
          ...
          : IStreamingReporter
  {
          ...
          bool assertionEnded(AssertionStats const &assertionStats) override
          {
                  ...
                  prepareExpandedExpression(
                          const_cast<AssertionResult &>( assertionStats
                                  .assertionResult )
                  );
  ...
  namespace detail
  {
    ...
    public:
            ...
            ) const -> InternalParseResult override
            {
                    ...
                    assert(!m_ref->isFlag());
                    auto valueRef = static_cast<detail::BoundValueRefBase *>( m_ref
                            .get());
                    ...
                    if (remainingTokens
                        && remainingTokens->type == TokenType::Option) {
                            ...
                            if (isMatch(token.token)) {
                                    if (m_ref->isFlag()) {
                                            auto flagRef = static_cast<detail::BoundFlagRefBase *>( m_ref
                                                    .get());
                                            auto result = flagRef
                                                    ->setFlag(true);
                                            if (!result) {
            ...
            : ParserBase
    {
            ...
            void writeToStream(std::ostream &os) const
            {
                    ...
                    for (
                            ...
                            auto row =
                                    TextFlow::Column(cols.left).width(optWidth)
                                                               .indent(2) +
                                    TextFlow::Spacer(4) +
...
namespace Catch
{
  ...
  clara::Parser makeCommandLineParser(ConfigData &config)
  {
          ...
          auto const setRngSeed = [&](std::string const &seed) {
                  if (seed != "time") {
                          return clara::detail::convertInto(
                                  seed,
                                  config.rngSeed
                          );
                  }
          ...
          auto const setReporter = [&](std::string const &reporter) {
                  IReporterRegistry::FactoryMap const &factories = getRegistryHub()
                          .getReporterRegistry()
                          .getFactories();
...
namespace
{
  ...
  {
          Catch::getCurrentContext().getResultCapture()
...
namespace Catch
{
  ...
  AssertionStats::AssertionStats(
          ...
          : assertionResult(_assertionResult),
            ...
            totals(_totals)
  {
          assertionResult.m_resultData
                         .lazyExpression
                         .m_transientExpression = _assertionResult.m_resultData
                                                                  .lazyExpression
...
namespace Catch
{
  ...
  std::size_t listTests(Config const &config)
  {
          ...
          for (
                  ...
                  Catch::cout()
                          << Column(testCaseInfo.name).initialIndent(2)
                                                      .indent(4)
                          << "\n";
                  ...
                  if (!testCaseInfo.tags.empty()) {
                          Catch::cout()
                                  << Column(testCaseInfo.tagsAsString()).indent(
                                          6
                                  )
                                  << "\n";
                  }
...
namespace Catch
{
  namespace Matchers
  {
    namespace Floating
    {
      ...
      {
              return "is within "
                     + ::Catch::Detail::stringify(m_margin)
                     + " of "
                     + ::Catch::Detail::stringify(m_target);
      }
...
namespace Catch
{
  ...
  >
  class Singleton
          : SingletonImplT, public ISingleton
  {
...
namespace Catch
{
  ...
  namespace Generators
  {
    struct GeneratorTracker
            : TestCaseTracking::TrackerBase, IGeneratorTracker
    {
            ...
            )
            {
                    ...
                    if (TestCaseTracking::ITrackerPtr childTracker = currentTracker
                            .findChild(nameAndLocation)) {
                            assert(childTracker);
  ...
  void RunContext::resetAssertionInfo()
  {
          ...
          m_lastAssertionInfo
                  .capturedExpression = "{Unknown expression after the reported line}"_sr;
  }
...
namespace Catch
{
  ...
  namespace
  {
    ...
    {
            auto reporter = Catch::getRegistryHub().getReporterRegistry()
                                                   .create(
                                                           reporterName,
                                                           config
                                                   );
    ...
    {
            if (Catch::getRegistryHub().getReporterRegistry()
                                       .getListeners()
                                       .empty()) {
            ...
            auto ret = std::unique_ptr<IStreamingReporter>(
                    new ListeningReporter
            );
            auto &multi = static_cast<ListeningReporter &>(*ret);
            auto const &listeners = Catch::getRegistryHub()
                    .getReporterRegistry()
                    .getListeners();
            for (
...
#if !defined(CATCH_CONFIG_DISABLE_EXCEPTIONS)
          const auto &exceptions = getRegistryHub()
  ...
  int Session::runInternal()
  {
          ...
          CATCH_TRY {
                  ...
                  return (std::min)(
                          MaxExitCode, (std::max)(
                                  totals.error, static_cast<int>(totals
                                          .assertions
                                          .failed)
                          )
                  );
...
namespace Catch
{
  ...
  auto makeStream(StringRef const &filename) -> IStream const *
  {
          if (filename.empty()) {
                  ...
                  if (filename == "%debug") {
                          ...
                          CATCH_ERROR("Unrecognised stream: '"
                                              << filename
                                              << "'");
          } else {
  ...
  ReusableStringStream::ReusableStringStream()
          : m_index(Singleton<StringStreams>::getMutable().add()),
            m_oss(
                    Singleton<StringStreams>::getMutable().m_streams[m_index]
                            .get()
            )
  {
  }
...
namespace Catch
{
  ...
  {
          CATCH_TRY {
                  getMutableRegistryHub().registerTagAlias(
                          alias,
                          tag,
                          lineInfo
                  );
...
namespace Catch
{
  ...
  void setTags(TestCaseInfo &testCaseInfo, std::vector<std::string> tags)
  {
          ...
          for (
                  ...
                  testCaseInfo
                          .properties = static_cast<TestCaseInfo::SpecialProperties>(
...
namespace Catch
{
  ...
  std::vector<TestCase> const &getAllTestCasesSorted(IConfig const &config)
  {
          return getRegistryHub().getTestCaseRegistry()
...
namespace Catch
{
  ...
  TestSpecParser &TestSpecParser::parse(std::string const &arg)
  {
          ...
          m_escapeChars.clear();
          for (
                  m_pos = 0; m_pos < m_arg.size(); ++m_pos
                  ) {
...
// Implementation of CompactReporter formatting
    ...
    private:
            ...
            void printRemainingMessages(Colour::Code colour = dimColour())
            {
                    ...
                    std::vector<MessageInfo>::const_iterator itEnd = messages
                            .end();
...
// Formatter impl for ConsoleReporter
    ...
    class Duration
    {
            ...
            static const uint64_t s_nanosecondsInAMinute = 60
  ...
  public:
          ...
          friend TablePrinter &operator<<(TablePrinter &tp, ColumnBreak)
          {
                  ...
                  auto padding = (
                                         strSize + 2
                                         < static_cast<std::size_t>(colInfo
                                                 .width)
                                 )
                                 ? std::string(
  ...
  void ConsoleReporter::benchmarkStarting(BenchmarkInfo const &info)
  {
          ...
          auto nameCol = Column(info.name).width(
                  static_cast<std::size_t>(m_tablePrinter->columnInfos()[0]
                                                   .width
                                           - 2 )
          );
...
namespace Catch
{
  ...
  void ListeningReporter::addReporter(IStreamingReporterPtr &&reporter)
  {
          ...
          m_reporter = std::move(reporter);
          m_preferences.shouldRedirectStdOut = m_reporter->getPreferences()
  ...
  void XmlReporter::testCaseEnded(TestCaseStats const &testCaseStats)
  {
          ...
          if (!testCaseStats.stdOut.empty()) {
                  m_xml.scopedElement("StdOut")
                       .writeText(trim(testCaseStats.stdOut), false);
          }
          if (!testCaseStats.stdErr.empty()) {
                  m_xml.scopedElement("StdErr")
                       .writeText(trim(testCaseStats.stdErr), false);
          }
